-- ============================================================
-- CENTER v5 — per-showcase defense % against sabotage
-- Defense is SUBTRACTED from the base 30% success roll.
--   basic     → 0%  (effective 30%)
--   glass     → 2%  (effective 28%)
--   premium   → 5%  (effective 25%)
--   legendary → 10% (effective 20%)
-- ============================================================

create or replace function showcase_defense(p_type text) returns numeric
language sql immutable as $$
  select case p_type
    when 'basic'     then 0.00
    when 'glass'     then 0.02
