-- ============================================================
-- CENTER v8 — sabotage cost scales with showcase tier
--   basic     30,000p  (0% defense, 1 slot)
--   glass     50,000p  (2% defense, 3 slots)
--   premium   100,000p (5% defense, 4 slots)
--   legendary 200,000p (10% defense, 5 slots)
-- Higher-tier showcases hold more slabs and take more defense, so
-- cracking them is a bigger commitment.
-- ============================================================
...
language sql immutable as $$
  select case p_type
    ...
    when 'glass'     then 50000
    when 'premium'   then 100000
    when 'legendary' then 200000
    else 100000
  end
$$;
