// AUTO-GENERATED — scripts/_build-name-to-dex.mjs.
// 한글 포켓몬 이름 → 전국도감(National Dex) 번호.
// 펫 / 방어 덱 카드의 sprite 렌더링용 — 야생 전투 sprite 와 동일 출처
// (PokeAPI gen5 BW 애니메이션) 사용해 비주얼 통일.
// 출처: sindresorhus/pokemon (https://github.com/sindresorhus/pokemon)

export const CARD_NAME_TO_DEX: Record<string, number> = {
  "이상해씨": 1,
  "이상해풀": 2,
  "이상해꽃": 3,
  "파이리": 4,
