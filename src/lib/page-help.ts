...
const GRADING_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    body: h(
      ...
      "(7·8·9·10 미만 선택) 옵션을 켜면 낮은 등급은 슬랩으로 만들지 않고 즉시 환산돼요. 슬랩 한도 500장에 가까울 때 유용."
    ),
  },
  {
    heading: "한도와 주의",
...
const GIFTS_SECTIONS: HelpSection[] = [
  ...
  },
  {
    heading: "주의",
    icon: "⚠️",
    body: "본인에게는 못 보내요. 만료·거절된 선물의 슬랩은 자동으로 보낸 사람에게 그대로 남아요. 받는 쪽이 PCL 한도(500장)에 차 있으면 수락이 거부돼요.",
  },
];
