...
export default function GradingView() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 md:px-6 py-3 md:py-6 fade-in">
      ...
      <section className="relative rounded-3xl overflow-hidden border border-fuchsia-500/30 bg-zinc-950">
        <LabScene />
        ...
        <div className="relative px-4 pt-5 pb-6 md:px-8 md:pt-8 md:pb-10 flex items-end gap-3 md:gap-6">
          <div className="shrink-0 relative">
            <div
              aria-hidden
              className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-32 md:w-44 h-3 rounded-full bg-black/55 blur-md"
            />
            <img
              src={OAK_SPRITE}
              alt="감정사 오박사"
          ...
          <div className="flex-1 min-w-0 pb-2 md:pb-4">
            <div className="relative inline-block max-w-full bg-white/95 text-zinc-900 rounded-2xl rounded-bl-none px-3 py-2 md:px-4 md:py-3 shadow-[0_8px_22px_-8px_rgba(0,0,0,0.7)]">
              <p className="text-[12px] md:text-sm font-bold leading-snug">
                어서 오게! 감별할 카드를 가져왔구먼.
              </p>
              <p className="mt-0.5 text-[11px] md:text-[12px] text-zinc-700 leading-snug">
                내 연구실 기계로 한 번에 등급을 매겨주지.
              </p>
              <span
                aria-hidden
...
/* ────────────────────────────────────────────────────────────
 * Lab scene (background) — clean wallpaper + floor + ambient glow
 * ──────────────────────────────────────────────────────────── */
function LabScene() {
  return (
    <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute inset-x-0 top-[18%] h-[28%] opacity-70">
        <div
      ...
      <div className="absolute right-0 bottom-0 w-[22%] h-3/5">
        <div
